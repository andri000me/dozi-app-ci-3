...
<div id="page-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">All Article <?= $user['nama_user']; ?></h1>
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <form action="<?= base_url('user/artikel'); ?>" method="post">
      ...
      <div class="modal-body">
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea name="deskripsi" id="editor1" class="form-control" cols="30" rows="10"></textarea>
