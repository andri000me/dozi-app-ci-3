                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if($a['status_artikel'] == '0') : ?>
                                                    <a href="<?= base_url('admin/artikel/review/') . $a['id_artikel']; ?>" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="top" title="Belum Dipiblikasikan"><i class="fa fa-eye fa-fw"></i></a>
                                                    <?php else: ?>
